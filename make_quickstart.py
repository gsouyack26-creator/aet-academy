...
c.drawRightString(W - M, H - 0.66*inch, "v13.43")
...
c.drawString(M, M - 0.12*inch, "AET Academy v13.43  \u2014  ACY1 RME training bundle.  Print this page and keep it with your workstation.")
